...
# Example usage
commands_per_server = [
    (('3.142.221.138', 22, 'ec2-user', r'D:\aws_learning\credentials\tg-demo-server-private.pem'), 'uptime'),
    (('18.223.116.177', 22, 'ec2-user', r'D:\aws_learning\credentials\tg-demo-server-private.pem'), 'df -h'),
    (('3.21.92.149', 22, 'ec2-user', r'D:\aws_learning\credentials\tg-demo-server-private.pem'), 'whoami')
]
